      ...
      {/* Hero Section */}
          <section className="relative space-y-12 min-h-screen flex items-center">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="grid md:grid-cols-1 gap-12 items-center w-full"
            >
              <motion.div
            ...
            Hi, I'm Sifat Ali
                  ...
                  <motion.div
                    className="text-2xl md:text-3xl font-semibold text-muted-foreground flex items-center gap-2"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <span className="text-primary">
                      <Typewriter
                        words={['Frontend Developer', 'AI Enthusiast']}
                        loop={0}
                        cursor
                        cursorStyle="|"
                        typeSpeed={70}
                ...
                >
                  <motion.p 
                    ...
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.5, ease: [0.42, 0, 0.58, 1] }}
                  >
                    I'm a <span className="text-primary font-semibold">Frontend Developer</span> passionate about 
                ...
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.8, ease: [0.42, 0, 0.58, 1] }}
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 2.5, repeat: Infinity, delay: 0.5, ease: [0.42, 0, 0.58, 1] }}
                    />
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8, delay: index * 0.2, ease: [0.42, 0, 0.58, 1] }}
                  />
                        ...
                        >
                          {exp.achievements.map((achievement, i) => (
                            <motion.li 
                              ...
                              viewport={{ once: true }}
                              transition={{ delay: i * 0.1, ease: [0.42, 0, 0.58, 1] }}
                            >
                              <motion.span 
                                className="text-primary mt-2 w-2 h-2 rounded-full bg-primary"
                                animate={{ scale: [1, 1.5, 1] }}
                                transition={{ duration: 2, repeat: Infinity, delay: i * 0.2, ease: [0.42, 0, 0.58, 1] }}
                              />
          ...
          <section className="space-y-12">
            ...
            >
              <motion.span 
                ...
                animate={{ height: [40, 50, 40] }}
                transition={{ duration: 2, repeat: Infinity, delay: 0.5, ease: [0.42, 0, 0.58, 1] }}
              />
              <h2 className="text-4xl font-bold flex items-center gap-4">
              ...
              <motion.div
                className="flex gap-1"
                animate={{ opacity: [0.5, 1, 0.5] }}
                transition={{ duration: 1.5, repeat: Infinity, delay: 0.5, ease: [0.42, 0, 0.58, 1] }}
              >
                      ...
                      >
                        {edu.skills.map((skill, i) => (
                          <motion.div
                            ...
                            whileInView={{ opacity: 1, scale: 1 }}
                            viewport={{ once: true }}
                            transition={{ delay: i * 0.05, ease: [0.42, 0, 0.58, 1] }}
                          >
                            <Badge 
                              variant="outline" 
          ...
          <section className="space-y-12">
            ...
            >
              <motion.span 
                className="w-2 h-10 rounded-full bg-gradient-to-b from-primary to-primary/60"
                animate={{ height: [40, 50, 40] }}
                transition={{ duration: 2, repeat: Infinity, delay: 1, ease: [0.42, 0, 0.58, 1] }}
              />
              <h2 className="text-4xl font-bold flex items-center gap-4">
              ...
              <motion.div
                className="flex gap-1"
                animate={{ opacity: [0.5, 1, 0.5] }}
                transition={{ duration: 1.5, repeat: Infinity, delay: 1, ease: [0.42, 0, 0.58, 1] }}
              >
                <Star className="w-4 h-4 text-primary" />
                <Star className="w-4 h-4 text-primary" />
                <Star className="w-4 h-4 text-primary" />
